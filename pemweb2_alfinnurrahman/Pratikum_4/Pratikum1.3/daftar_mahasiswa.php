...
$array_maha1 = new Mahasiswa(get_NimRandom(), "Sarmi", 2019, "Teknik Informatika", 2.1);
$array_maha2 = new Mahasiswa(get_NimRandom(), "Supono", 2020, "Teknik Informatika", 2.7);
$array_maha3 = new Mahasiswa(get_NimRandom(), "naruto", 2020, "Sistem Informati", 3.0);
$array_maha4 = new Mahasiswa(get_NimRandom(), "takemichi", 2021, "Teknik Informatika", 3.5);
$array_maha5 = new Mahasiswa(get_NimRandom(), "jameto", 2018, "Teknik Informatika", 4.0);
